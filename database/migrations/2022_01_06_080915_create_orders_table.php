...
class CreateOrdersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('orders', function (Blueprint $table) {
            ...
            $table->integer('order_numder')->nullable(); // 金流方紀錄的訂單編號
            $table->timestamps();
        });
    }
    ...
    php artisan krlove:generate:model ShoppingCart --table-name=shopping_carts
    php artisan krlove:generate:model OrderDetail --table-name=Order_details
