...
@section('main')
    <div class="container">
        <form action="/product/update/{{$productData->id}}" enctype="multipart/form-date" method="post">
            @csrf
            <div class="row">
            ...
            <div class="row ">
                ...
                <div id="upload-img">
                    @foreach ($productData->imgs as $img)
                        <div class="imgcard">
                            <div class="delete-img" data-path="{{ $img->image_path }}">x</div>
                            <img src="{{ $img->image_path }}" alt="" width="200px">
            ...
            <div class="row">
                ...
                <input type="number" id="qty" name="qty" value="{{ $productData->qty }}">
            </div>
